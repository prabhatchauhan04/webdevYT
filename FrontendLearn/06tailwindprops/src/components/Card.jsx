...
// destructuring krdi 'props' ki argument mein hi . props.userName krke bhi use krsakte the userName
...
const Card = ({userName,job="jobless"}) => {
    return (
        <>
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex flex-col items-center pb-10">
                    <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://cdn.pixabay.com/photo/2018/01/03/19/54/fashion-3059143_1280.jpg" alt="Bonnie image" />
